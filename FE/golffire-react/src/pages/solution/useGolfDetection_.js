...
export default function useGolfDetection_(
  videoRef,
  canvasRef,
  setIsRecordingDone,
  setVideoURL,
          ...
          function predict() {
            ...
            model.estimateSinglePose(video).then(pose => {
              ...
              if (
                ...
                // const leftWrist = pose.keypoints[9].position;
                // const rightWrist = pose.keypoints[10].position;
                // const currentShoulderMiddlePointX =
                //   (leftShoulder.x + rightShoulder.x) / 2;
                // const currentShoulderMiddlePointY =
                //   (leftShoulder.y + rightShoulder.y) / 2;
                // const currentWristMiddlePointX =
                //   (leftWrist.x + rightWrist.x) / 2;
                // const currentWristMiddlePointY =
  ...
  function checkIsPush(pose) {
    ...
    return (
      ...
      wristMiddlePointY <= rightShoulder.y
    );
  }
  ...
  function analyzePose(recordedPose) {
    ...
    // const ellipseFactor = checkPointOnEllipse(
    //   rightWrist.x,
    //   rightWrist.y,
    //   centerX,
    //   centerY,
    ...
    //   b2
    // );
    // const HipFactor = checkHip(HipX, HipY);
    // const HeadFactor = checkHead(HeadX, HeadY);
    // const ShoulderFactor = checkShoulder(ShoulderX, ShoulderY);
    // const KneeFactor = checkKnee(rightKnee.x, rightKnee.y);

    // console.log(ellipseFactor, a2, b2, HipFactor, HeadFactor, ShoulderFactor, KneeFactor);
    return [
